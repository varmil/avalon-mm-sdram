...
`timescale 1 ps / 1 ps
module avalon_mm_interconnect_0 (
	...
	wire  [101:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> mm_bridge_0_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                                  // mm_bridge_0_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                // rsp_mux:src_channel -> mm_bridge_0_m0_agent:rp_channel
	...
	wire   [84:0] new_sdram_controller_0_s1_agent_rf_source_data;                     // new_sdram_controller_0_s1_agent:rf_source_data -> new_sdram_controller_0_s1_agent_rsp_fifo:in_data
	...
	wire   [84:0] new_sdram_controller_0_s1_agent_rsp_fifo_out_data;                  // new_sdram_controller_0_s1_agent_rsp_fifo:out_data -> new_sdram_controller_0_s1_agent:rf_sink_data
	...
	wire  [101:0] mm_bridge_0_m0_agent_cp_data;                                       // mm_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire   [83:0] new_sdram_controller_0_s1_agent_rp_data;                            // new_sdram_controller_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire   [83:0] new_sdram_controller_0_s1_burst_adapter_source0_data;               // new_sdram_controller_0_s1_burst_adapter:source0_data -> new_sdram_controller_0_s1_agent:cp_data
	...
	wire    [1:0] new_sdram_controller_0_s1_burst_adapter_source0_channel;            // new_sdram_controller_0_s1_burst_adapter:source0_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire          router_002_src_valid;                                               // router_002:src_valid -> new_sdram_controller_0_s1_rsp_width_adapter:in_valid
	wire   [83:0] router_002_src_data;                                                // router_002:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                               // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                             // router_002:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                       // router_002:src_startofpacket -> new_sdram_controller_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                         // router_002:src_endofpacket -> new_sdram_controller_0_s1_rsp_width_adapter:in_endofpacket
	...
	wire  [101:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;               // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [1:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [101:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                  // new_sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire   [83:0] new_sdram_controller_0_s1_cmd_width_adapter_src_data;               // new_sdram_controller_0_s1_cmd_width_adapter:out_data -> new_sdram_controller_0_s1_burst_adapter:sink0_data
	...
	wire    [1:0] new_sdram_controller_0_s1_cmd_width_adapter_src_channel;            // new_sdram_controller_0_s1_cmd_width_adapter:out_channel -> new_sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	avalon_mm_interconnect_0_router router (
	...
	avalon_mm_interconnect_0_router router_001 (
	...
	avalon_mm_interconnect_0_router_002 router_002 (
	...
	avalon_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                              //       clk.clk
		.reset               (new_sdram_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                   //       clk.clk
		.reset              (new_sdram_controller_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	avalon_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
